<?php namespace App\Http\Controllers;
	...
	class AdminPostsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Author Id","name"=>"author_id","join"=>"author,id"];
			$this->col[] = ["label"=>"Category Id","name"=>"category_id"];
			$this->col[] = ["label"=>"Title","name"=>"title"];
			$this->col[] = ["label"=>"Seo Title","name"=>"seo_title"];
		...
		$this->form = [];
		$this->form[] = ["label"=>"Author Id","name"=>"author_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"author,id"];
		...
		$this->form[] = ["label"=>"Excerpt","name"=>"excerpt","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
		...
		$this->form[] = ["label"=>"Meta Description","name"=>"meta_description","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
