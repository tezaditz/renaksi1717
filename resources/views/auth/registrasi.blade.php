...
<head>
    <meta charset="UTF-8">
    <title>Registration : eMonev BBO</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('PostRegistration') }}" method="post">
            <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
            
           
            <div class="form-group has-feedback">
                <input autocomplete='off' type="text" class="form-control" name='company_name' required placeholder="Nama Perusahaan"/>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input autocomplete='off' type="text" class="form-control" name='npwp' required placeholder="npwp"/>
                <span class="glyphicon glyphicon-credit-card form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input autocomplete='off' type="text" class="form-control" name='user_elic' required placeholder="Username Elicensing"/>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
            ...
            <div style="margin-bottom:10px" class='row'>
                <div class='col-xs-12'>
                    <button type="submit" class="btn btn-success btn-block btn-flat"><i class='fa fa-paper-plane-o'></i> Daftar</button>
                    <a href="/bbo/login" class='btn btn-danger btn-block btn-flat'><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Kembali</a>
                </div>
                </div>
            </div>
